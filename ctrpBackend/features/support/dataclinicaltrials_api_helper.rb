...
class Dataclinicaltrials_api_helper
  ...
  def self.trigger_field_values_post(service, service_url_method, username, password, headers, study_prtcl_id_dct, nci_id_dct, exported_from_us_dct, gender_desc_dct, seq_assignment_dct, fda_reglted_drug_dct, post_pror_aprval_dct, ped_pstmrkt_srv_dct, masking_desc_dct, fda_rglatd_divce_dct, model_desc_dct, gender_based_dct)
    service_url = ENV[service_url_method]
    @request_hash = prepare_add_values_dct_ms(study_prtcl_id_dct, nci_id_dct, exported_from_us_dct, gender_desc_dct, seq_assignment_dct, fda_reglted_drug_dct, post_pror_aprval_dct, ped_pstmrkt_srv_dct, masking_desc_dct, fda_rglatd_divce_dct, model_desc_dct, gender_based_dct)
